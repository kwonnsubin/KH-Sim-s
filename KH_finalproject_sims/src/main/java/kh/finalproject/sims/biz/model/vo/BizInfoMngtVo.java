...
//	LOGO_RENAME_FILENAME          VARCHAR2(100) 
	...
	public BizInfoMngtVo(String bizId, String bizName, String bizSsn, String bizCrn, String bizEmail, String bizPhone,
			String bizFax, String bizOwnerName, String bizHp, String bizLocation, String bizCardPayDate,
	...
	public String toString() {
		return "BizInfoMngtVo [bizId=" + bizId + ", bizName=" + bizName + ", bizSsn=" + bizSsn + ", bizCrn=" + bizCrn
				...
				+ bizOwnerName + ", bizHp=" + bizHp + ", bizLocation=" + bizLocation + ", bizCardPayDate="
				+ bizCardPayDate + ", bizAccPayDate=" + bizAccPayDate + ", bizBeginTime=" + bizBeginTime
				+ ", bizEndTime=" + bizEndTime + ", bizClosedDay=" + bizClosedDay + ", bizReviewStar=" + bizReviewStar
				+ ", phoneOpTime=" + phoneOpTime + ", phoneOpTimeUsim=" + phoneOpTimeUsim + ", network=" + network
				+ ", writeDate=" + writeDate + ", updateDate=" + updateDate + ", logoRenameFilename="
				+ logoRenameFilename + "]";
	}
