...
public class kakaoController {
	...
	public ModelAndView kakao(ModelAndView mv) throws Throwable {
		mv.setViewName("apitest/kakaologin");
		return mv;
	}
	...
	public ModelAndView kakaoLogin(@RequestParam(value = "code", required = false) String code) throws Throwable {
		...
		// ycpNuuYp935PeskorFF5JVh_lomLj4R-p1a24fmoRpKUf02VTa_DdkJEbV-nmGskn4P2Ugo9c04AAAGG1TD2cA 코드
