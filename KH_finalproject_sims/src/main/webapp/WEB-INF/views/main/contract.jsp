	    ...
	    <div class="input-form-backgroud row">
	      <div class="input-form col-md-12 mx-auto">
		    ...
		    <section id="fregister_term">
		        ...
		        <textarea class="mb-5" readonly="">제1조(목적) 이 약관은 업체 회사(전자상거래 사업자)가 운영하는 업체 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
		...
		제24조(재판권 및 준거법)
		  ...
		  ② “몰”과 이용자 간에 제기된 전자상거래 소송에는 한국법을 적용합니다.
		    ...
		    <section id="fregister_private">
				...
				<textarea class="mb-5" readonly="">개인정보처리방침
    ...
    $(document).ready(function() {
    	$('.all-check').on('change', function() {
    		if($('.all-check').is(':checked')) {
	    		$('.allow-check').prop('checked', true);
	    		$('.personal-check').prop('checked', true);
    		} else {
    			$('.allow-check').prop('checked', false);
	    		$('.personal-check').prop('checked', false);
    		}
    	});
    	
    	$('.allow-check').on('click', function() {
    		if($('.allow-check').is(':checked') == true && $('.personal-check').is(':checked') == true) {
    	...
    	$('.personal-check').on('click', function() {
    		if($('.allow-check').is(':checked') == true && $('.personal-check').is(':checked') == true) {
    			$('.all-check').prop('checked', true);
    		} else {
	    		$('.all-check').prop('checked', false);
    	...
    	$('.join-btn').on('click', function() {
    		if($('.allow-check').is(':checked') == true && $('.personal-check').is(':checked') == true) {
    			...
    			$(".alert-div").html("<p style='color: red;'>회원가입약관의 내용에 동의하셔야 회원가입 하실 수 있습니다.</p>");
