													...
													<c:choose>
														...
														<c:otherwise>
															<li class="page-item"><a class="page-link"
															 href="${path}/admin/qna/list?p=${requestScope.paging.prevPage }&searchType=${searchType }&keyword=${keyword }">prev</a></li>
														</c:otherwise>
													</c:choose>
													<c:forEach var="pNum" items="${requestScope.paging.pageList }">
														<li class="page-item ${pNum eq pageNumber ? 'active' : '' }"><a class="page-link" 
														href="${path}/admin/qna/list?p=${pNum }&searchType=${searchType }&keyword=${keyword }">${pNum }</a></li>
													</c:forEach>
													<c:choose>
														...
														<c:otherwise>
															<li class="page-item"><a class="page-link"
															 href="${path}/admin/qna/list?p=${requestScope.paging.nextPage }&searchType=${searchType }&keyword=${keyword }">next</a></li>
														</c:otherwise>
													</c:choose>
												</ul>
											</nav>
