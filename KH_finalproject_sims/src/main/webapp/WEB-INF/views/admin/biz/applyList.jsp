													...
													<div class="col-sm-12">
														<div class="input-group">
															...
															<select class="" name="searchOption">
																...
																<option value="content" <c:if test="${searchOption eq 'writer' }">selected</c:if>>작성자</option>
															</select>
										...
										<div class="card-body table-border-style">
											<div class="table-responsive">
												<table class="table table-hover">
													...
													<tbody>
														<c:forEach var="list" items="${bizApplyList}" varStatus="status">
															<tr>
																<td>${status.count}</td>
																<td>${list.bizName}</a></td>
