							...
							<div class="card-body">
								<table style="width: 100%">
									<tr>
										...
										<td>
											<input type="radio" class="btn-check" name="join-category" value="1" id="change-num" autocomplete="off" checked="checked">
											<label class="btn btn-toggle btn-outliine-secondary" for="change-num">번호이동</label>
											
											<input type="radio" class="btn-check" name="join-category" value="2" id="new-num" autocomplete="off">
											<label class="btn btn-toggle btn-outliine-secondary" for="new-num">신규가입</label>
										</td>
									</tr>
									<tr>
										<td>유심보유</td>
										<td>
											...
											<label class="btn btn-toggle btn-outliine-secondary" for="no-sim">없어요(택배 요청)</label>
											
											<input type="radio" class="btn-check" name="sim-yn" value="2" id="yes-sim" autocomplete="off">
											<label class="btn btn-toggle btn-outliine-secondary" for="yes-sim">가지고 있어요</label>
										</td>
									</tr>
									<tr>
										<td>유심유형</td>
										<td>
											...
											<label class="btn btn-toggle btn-outliine-secondary" for="no-sim">일반유심</label>
											
											<input type="radio" class="btn-check" name="sim-type" value="2" id="nfc-sim" autocomplete="off">
											<label class="btn btn-toggle btn-outliine-secondary" for="yes-sim">NFC유심</label>
										</td>
									</tr>
								</table>
							</div>
