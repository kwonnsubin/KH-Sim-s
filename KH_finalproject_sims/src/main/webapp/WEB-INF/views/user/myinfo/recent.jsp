...
<head>
    ...
    <link rel="stylesheet" href="<%= request.getContextPath() %>/resources/css/user/recent.css"/>
...
<body>
    ...
    <section>
		<div class="container-fluid d-flex justify-content-center mt-5 recent-plan-div">
	       	<div class="row recent-plan-row">
	       		<div class="col">
       				<div class="mb-5">
	       				<p class="recent-plan-p" style="font-weight: bold;">최근 본 요금제</p>
       				</div>
       				<div>
