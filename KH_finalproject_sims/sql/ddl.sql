...
CREATE TABLE USER_TABLE(
	...
	, USER_STATUS NUMBER(1) NULL CHECK (USER_STATUS IN (0, 1, 2))
...
ALTER TABLE USER_TABLE MODIFY (ROLE DEFAULT 'ROLE_USER');
-- 사용자 번호 시퀀스 생성
...
CREATE TABLE ADMIN(
	 ADMIN_ID VARCHAR2(30) NOT NULL 
   , ADMIN_PW VARCHAR2(80) NOT NULL
   , ROLE VARCHAR2(20) NOT NULL
);

ALTER TABLE ADMIN ADD CONSTRAINT ADMIN_ADMIN_ID_PK PRIMARY KEY (ADMIN_ID);
ALTER TABLE ADMIN MODIFY (ROLE DEFAULT 'ROLE_ADMIN');
