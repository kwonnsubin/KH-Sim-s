...
ALTER TABLE QNA_ANS ADD CONSTRAINT FK_QNA_TO_ANS FOREIGN KEY (AQ_NO) REFERENCES QNA(AQ_NO);
...
ALTER TABLE QNA_RPL ADD CONSTRAINT FK_ANS_TO_RPL FOREIGN KEY (AA_NO) REFERENCES QNA_ANS(AA_NO);
...
CREATE TABLE BIZ_REVIEW (
    ...
    REVIEW_IS_DELETE NUMBER DEFAULT 1 CHECK (REVIEW_IS_DELETE IN (1, 2)), 
...
CREATE TABLE REVIEW_REPORT (
    ...
    , CONSTRAINT REVIEW_REPORT_REVIEW_NO_FK FOREIGN KEY(REVIEW_NO) REFERENCES BIZ_REVIEW(REVIEW_NO)
);
